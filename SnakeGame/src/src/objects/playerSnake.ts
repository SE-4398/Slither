...
export class playerSnakePart {
    ...
    private buildSnake(scene): void {
        ...
        for(let i = 0; i <= this.snakeLength; i++){
            if(i === 0){
                //head
                this.body[i] = scene.physics.add.sprite(this.startingX, this.startingY, "masterAtlas", this.prefixToUse + "Head_right");
            }
