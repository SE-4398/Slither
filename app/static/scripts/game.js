...
var tutorialScene_1 = require("../scenes/tutorialScene");
var config = {
    type: Phaser.AUTO,
    scale: {
        parent: "game",
    ...
    scene: [mainMenu_1.menuScene, options_1.optionsScene, creditScene_1.creditScene, snakeGame_1.gameScene, pauseScreen_1.pauseScene, gameOver_1.gameOverScene, tutorialScene_1.tutorialScene],
